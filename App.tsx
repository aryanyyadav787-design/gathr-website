    ...
    <div className="w-full h-full bg-white flex flex-col relative font-display text-black">
       ...
       <div className="absolute bottom-[4.5rem] left-0 right-0 bg-brand border-y-2 border-black py-2 px-3 flex items-center justify-between z-10">
          <div className="flex items-center gap-2 overflow-hidden flex-1">
             {/* Updated to a reliable placeholder since the user-uploaded image link expired or is broken */}
             <img src="https://images.unsplash.com/photo-1619983081593-e2ba5b543e60?q=80&w=150&auto=format&fit=crop" className="w-10 h-10 rounded border border-black shrink-0 object-cover" alt="album" />
              ...
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4">
                    ...
                    <Button type="submit" size="lg" className="font-milker text-xl tracking-widest bg-brand text-black hover:bg-black hover:text-white transition-colors duration-200">
                      JOIN WAITLIST
                    </Button>
                  </form>
      ...
      <footer className="bg-black text-white py-12 px-4 border-t-2 border-brand">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-6">
            <a href="#" className="font-bold hover:text-brand transition-colors">INSTAGRAM</a>
            <a href="#" className="font-bold hover:text-brand transition-colors">TWITTER</a>
            <a href="#" className="font-bold hover:text-brand transition-colors">TIKTOK</a>
          </div>
        </div>
      </footer>
